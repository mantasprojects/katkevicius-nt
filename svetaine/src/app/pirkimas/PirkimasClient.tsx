             ...
             >
                <div className="flex flex-col md:flex-row gap-3 w-full">
                   <input 
                     ...
                     required
                     className="w-full flex-1 bg-white border border-slate-200 rounded-xl px-4 h-14 min-h-14 appearance-none text-base focus:outline-none focus:ring-2 focus:ring-[#2563EB]/20 text-slate-900 placeholder:text-slate-400" 
                     value={fomoEmail}
