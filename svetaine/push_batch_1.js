...
async function pushUpdates() {
  const posts = require('./batch_1_optimized.json');
  ...
  // Supabase upsert gali priimti masyvą įrašų
  // Tai darys vieną masinį update/insert užklausą
  ...
  if (error) {
    ...
    console.log(`Sėkmingai atnaujinta ${posts.length} įrašų Supabase!`);
  }
}
